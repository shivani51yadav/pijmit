...
@section('content')
    ...
    <div
        class="flex flex-col md:flex-row gap-10 justify-center align-top p-4 md:p-10 shadow-lg bg-white md:max-w-[80%] m-auto mt-20 md:mt-20 mb-10 rounded-xl dark:bg-slate-700 ">
        <div class="About block md:h-1/3 w-full md:w-2/3 ">
            ...
            <div
                class="block flex flex-col gap-3 max-w-full rounded-lg bg-white text-left shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
                <div class="p-6 mt-14">
                    ...
                    <div class="paper-2">
                        <a href="">
                            <p
                                class="mt-6 text-base leading-normal text-neutral-600 dark:text-neutral-200 dark:hover:text-yellow-500">
                ...
                <div
                    ...
                    <div class="p-6">
                        ...
                        <div class="paper-1">
                            <a href="">
                                <p
                                    class="mt-6 text-base leading-normal text-neutral-600 dark:text-neutral-200 dark:hover:text-yellow-500  hover:text-underline">
