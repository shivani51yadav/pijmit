                            ...
                            <div class="relative w-full max-w-md max-h-full">
                                ...
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <div class="px-6 py-6 lg:px-8">
                                        <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Volume Add</h3>
                                        <form class="space-y-6" action="{{ route('volumes.store') }} " method="POST">
                                            @csrf
                                            <div>
                                                <label for="vol_no"
                                            ...
                                            <div>
                                                <label for="vol_year"
                                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Volume
                                                    year</label>
                                                <input type="text" name="vol_year" id="vol_year"
                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4 space-x-4">
                                    <a href="{{route('volumes.show',$volume->vol_no)}}" class="font-medium text-green-600 dark:text-green-500 pl-4 ">Show</a>
                                    <a href="{{ route('volumes.edit', ['vol_no' => $volume->vol_no]) }}" class="font-medium text-blue-600 dark:text-blue-500 ">Edit</a>
                                    <a href="{{route('volumes.destroy',$volume->vol_no)}}" class="font-medium text-red-600 dark:text-red-500 ">Delete</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
