<div dir="rtl" class="flex flex-col justify-items-center gap-2 pt-10 ">
    <div class="other_links">
        <h3 class=" text-lg font-medium text-center md:text-right md:hover:underline md:pb-4 pl-4 pr-4 dark:text-gray-600">Other Links
        </h3>
    </div>
    <div
        ...
        <a href="#" class="flex justify-center items-center w-full">
            <img class=" rounded-t-lg w-auto h-auto md:w-40 md:h-40 object-contain p-2"
                src="https://pjitm.com/images/sanchayan/sanchayan.jpg" alt="" />
        </a>
    ...
    <div
        ...
        <a href="#" class="flex justify-center items-center w-full">
            <img class=" rounded-t-lg w-auto h-auto md:w-40 md:h-40 object-contain p-2"
                src="https://pjitm.com/images/sanchayan/proquest_logo.jpg" alt="" />
        </a>
        <div class="p-5  flex flex-col justify-start">
            <a href="#">
                <h5
    ...
    <div
        ...
        <a href="#" class="flex justify-center items-center w-full">
            <img class="rounded-t-lg w-auto h-auto md:w-40 md:h-40 object-contain p-2"
                src="https://pjitm.com/images/sanchayan/publons.png" alt="" />
        </a>
        <div class="p-5 flex flex-col justify-start">
            <a href="#">
                <h5
    ...
    <div
        ...
        <a href="#" class="flex justify-center items-center w-full">
            <img class="rounded-t-lg w-auto h-auto md:w-40 md:h-40 object-contain p-2"
                src="https://pjitm.com/images/sanchayan/crossref-logo.jpeg" alt="" />
        </a>
